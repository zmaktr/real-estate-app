...
class Property(TimeStampUUIDModel):
    ...
    class PropertyType(models.TextChoices):
        ...
        COMMERICAL  = "Commerical", _("Commerical")
        OTHER       = "Other",      _("Other")
    ...
    description         = models.TextField      (verbose_name=_('Description'), default='Please add description ... ')
    country             = CountryField          (verbose_name=_('Country'), default='US', blank_label='(select country)')
    city                = models.CharField      (verbose_name=_('City'), max_length=180, default='Austin')
